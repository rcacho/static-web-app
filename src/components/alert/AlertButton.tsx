import { Avatar, Badge, ClickAwayListener, Popper, Stack, Typography } from "@mui/material";
...
const AlertPanel = (props: any) => {
    ...
    const renderAlerts = () => {
        ...
        for (const alert of alerts) {
            ...
            alertItems.push(<AlertItem key={alert} alert={alert} handleClick={handleClick}/>)
        }
        return alertItems
    }
