...
const ChangeCategories = (props: any) => {
    ...
    function renderList(props: ListChildComponentProps) {
        ...
        return (
            <ListItem style={style} key={index} component="div" disablePadding onClick={handleSelect}>
    ...
    return (
        <ThemeProvider theme={MuiTheme}>
            <List disablePadding={true}>
                <ListItem>
                    <ListItemText sx={{color: "#898989", textDecoration: "underline"}} secondary="Change Categories"/>
                </ListItem>
                <ListItem>
            ...
            <List className='bottom-buttons-cat' disablePadding={true}>
                <ListItem style={{display:'flex', justifyContent:'center'}} >
                    <Button className='menu-button' size="small" variant="contained" color="primary">
                        Add New Category
                    </Button>
                </ListItem>
                <ListItem style={{display:'flex', justifyContent:'center'}} >
